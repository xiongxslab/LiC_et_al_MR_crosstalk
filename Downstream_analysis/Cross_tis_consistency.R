...
wtd.cor(MR_results_m6A2ha_combine$b_Tis1, MR_results_m6A2ha_combine$b_Tis2, 1/(MR_results_m6A2ha_combine$se_Tis2)^2)
wtd.cor(MR_results_ha2m6A_combine$b_Tis1, MR_results_ha2m6A_combine$b_Tis2, 1/(MR_results_ha2m6A_combine$se_Tis2)^2)
wtd.cor(MR_results_m6A2me_combine$b_Tis1, MR_results_m6A2me_combine$b_Tis2, 1/(MR_results_m6A2me_combine$se_Tis2)^2)
wtd.cor(MR_results_me2m6A_combine$b_Tis1, MR_results_me2m6A_combine$b_Tis2, 1/(MR_results_me2m6A_combine$se_Tis2)^2)
